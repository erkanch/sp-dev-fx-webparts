# Command Set Extensions for Pages
...
## Contributors
* [Erkan Celme](https://github.com/erkanch)

## Version history

Version|Date|Comments
-------|----|--------
1.0|March 21, 2023|Initial release

## Minimal path to awesome

* Clone this repository (or [download this solution as a .ZIP file](https://pnp.github.io/download-partial/?url=https://github.com/pnp/sp-dev-fx-webparts/tree/main/samples/react-cmdset-extensions) then unzip it)
* From your command line, change your current directory to the directory containing this sample (`react-cmdset-extensions`, located under `samples`)
